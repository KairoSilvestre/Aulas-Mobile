...
import { morningSchedule, nightSchedule, ScheduleItemProps } from './mocks/scheduleData';
...
function MainContent() {
  ...
  // Tipagem correta do renderItem usando ScheduleItemProps
  const renderItem = ({ item }: { item: ScheduleItemProps }) => (
